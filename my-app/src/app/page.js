  ...
  return (
    <>
      <div className="text-center">
        ...
        <section className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-custom-white p-8 text-center rounded-lg shadow-lg hover:shadow-2xl border border-custom-green transition duration-200">
                <div className='w-full flex justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-12 mb-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197A5.971 5.971 0 0 0 7.539 15.523M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
                  </svg>
                </div>
          ...
          <Link href="/itinerary" passHref>
            <a className="block">
              <div className="bg-custom-white p-8 text-center rounded-lg shadow-lg hover:shadow-2xl border border-custom-green transition duration-200">
                <div className='w-full flex justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-12 mb-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2m4 0v4m-4-4h.01M8 12h8m-8 4h8m-8 4h8" />
                  </svg>
                </div>
          ...
          <Link href="/bookings" passHref>
            <a className="block">
              <div className="bg-custom-white p-8 text-center rounded-lg shadow-lg hover:shadow-2xl border border-custom-green transition duration-200">
                <div className='w-full flex justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-12 mb-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6h5.75" />
                  </svg>
                </div>
          ...
          <Link href="/chat" passHref>
            <a className="block">
              <div className="bg-custom-white p-8 text-center rounded-lg shadow-lg hover:shadow-2xl border border-custom-green transition duration-200">
                <div className='w-full flex justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-12 mb-4">
                    <path fillRule="evenodd" d="M2.09 15a1 1 0 0 0 1-1V8a1 1 0 1 0-2 0v6a1 1 0 0 0 1 1ZM5.765 13H4.09V8c.663 0 1.218-.466 1.556-1.037a4.02 4.02 0 0 1 1.358-1.377c.478-.292.907-.706.989-1.26V4.32a9.03 9.03 0 0 0 0-2.642c-.028-.194.048-.394.224-.479A2 2 0 0 1 11.09 3c0 .812-.08 1.605-.235 2.371a.521.521 0 0 0 .502.629h1.733c1.104 0 2.01.898 1.901 1.997a19.831 19.831 0 0 1-1.081 4.788c-.27.747-.998 1.215-1.793 1.215H9.414c-.215 0-.428-.035-.632-.103l-2.384-.794A2.002 2.002 0 0 0 5.765 13Z" />
                  </svg>
                </div>
          ...
          <Link href="/location-share" passHref>
            <a className="block">
              <div className="bg-custom-white p-8 text-center rounded-lg shadow-lg hover:shadow-2xl border border-custom-green transition duration-200">
                <div className='w-full flex justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-12 mb-4">
          ...
          <Link href="/local-recommendations" passHref>
            <a className="block">
              <div className="bg-custom-white p-8 text-center rounded-lg shadow-lg hover:shadow-2xl border border-custom-green transition duration-200">
                <div className='w-full flex justify-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-12 mb-4">
        ...
        <section className="text-center my-12">
          <Link href="/signup">
            <a className="text-blue-500 hover:text-blue-700">Create an Account</a>
          </Link>
